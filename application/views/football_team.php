                           ...
                           <div id="tab-1" class="fs-table tab-content" style=" display:block;">
                              <div class="odds-content">
                                    ...
                                    <tr id="g_1_ENxpnY1b" class="<?=$class?> stage-finished" style="cursor: pointer;">
                                       ...
                                       <td class="cell_ab team-home <?php if($val->home_score > $val->away_score){echo "bold";} ?>" title="Karsilasmanin detaylari için tiklayiniz!"><span class="padr"><?=$val->home_team?></span></td>
                                       <td class="cell_ac team-away <?php if($val->home_score < $val->away_score){echo "bold";} ?>" title="Karsilasmanin detaylari için tiklayiniz!"><span class="padl"><?=$val->away_team?></span></td>
