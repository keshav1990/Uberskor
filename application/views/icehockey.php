...
#def-form-table td input, textarea { padding: 4px 4px; margin-bottom: 8px;border-radius: 2px; }	 #def-form-table td textarea {resize: none; }	 #def-form-table td select  { width:159px;padding: 4px 4px;margin-bottom: 8px;border-radius: 2px;}
   ...
   /*for footer color and font color*/
         ...
         <div class="content soccer_inner">
            ...
            <div id="main">
               ...
               <div id="lc">
					 ...
					 <span class="side_mobile_bx ulkeler">Liglerim</span>
                        <ul class="menu country-list my-leagues mob_lst-cnt" title="">
	...
	<?php
	$this->load->view("icehockey/sidebar");
	?>
	 ...
	 $.getJSON(url , {date:date}, function( data ) {
		...
		$.each(data,function(e,v){
			...
			var pid = $(".<?=$game?>_event_"+v.id).attr("id");
				...
				trHtml1 += "";
				trHtml1 += " <td onclick=\"detailPopup('"+v.id+"')\" colspan=\"5\" class=\"cell_ab team-home  \" title=\" \"><span class=\"padl ";
				...
				trHtml1 += "";
				trHtml1 += "<td onclick=\"detailPopup('"+v.id+"')\" colspan=\"1\" class=\"cell_sc score-home\">"+isNull(v.home_score)+"<\/td>";
				trHtml1 += "";
				trHtml1 += "<td onclick=\"detailPopup('"+v.id+"')\" colspan=\"1\" class=\"cell_sd part-bottom\">"+isNull(v.home_result[0].p1)+"<\/td>";
				trHtml1 += "";
				trHtml1 += "<td onclick=\"detailPopup('"+v.id+"')\" colspan=\"1\" class=\"cell_se part-bottom\">"+isNull(v.home_result[0].p2)+"<\/td>";
				trHtml1 += "";
				trHtml1 += "<td onclick=\"detailPopup('"+v.id+"')\" colspan=\"1\" class=\"cell_sf part-bottom\">"+isNull(v.home_result[0].p3)+"<\/td>";
				trHtml1 += "";
				trHtml1 += "<td onclick=\"detailPopup('"+v.id+"')\" rowspan=\"2\" colspan=\"2\" class=\"cell_oq comparison\">";
				trHtml1 += "<span class=\"live-centre-inr\"> <b><\/b><\/span>";
				trHtml1 += "<\/td>";

				var trHtml2="";
				trHtml2 += "<td onclick=\"detailPopup('"+v.id+"')\" colspan=\"5\" class=\"cell_ac team-away\" title=\"\"><span class=\"padl ";
				if(v.home_score < v.away_score){
						trHtml2 += "bold ";
				}
				trHtml2 +=  "\" >";
				...
				trHtml2 += "";
				trHtml2 += "<td onclick=\"detailPopup('"+v.id+"')\" colspan=\"1\" class=\"cell_ta score-away \">"+isNull(v.away_score)+"<\/td>";
				trHtml2 += "";
				trHtml2 += "<td onclick=\"detailPopup('"+v.id+"')\" colspan=\"1\" class=\"cell_tb part-top\">"+isNull(v.away_result[0].p1)+"<\/td>";
				trHtml2 += "";
				trHtml2 += "<td onclick=\"detailPopup('"+v.id+"')\" colspan=\"1\" class=\"cell_tc part-top\">"+isNull(v.away_result[0].p2)+"<\/td>";
				trHtml2 += "";
				trHtml2 += "<td onclick=\"detailPopup('"+v.id+"')\" colspan=\"1\" class=\"cell_td part-top\">"+isNull(v.away_result[0].p3)+"<\/td>";
