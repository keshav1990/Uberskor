                                  ...
                                  //exit;
                                    if (!empty($centerleagues)) {
                                      ...
                                      ///this is to check if country exist or not
                                        if (!array_key_exists($league1->country_name, $listNew1)) {
                                          continue ;
                                        }
                                        $listNewN = $listNew1[$league1->country_name];
                                  //  echo $c->name.$league1->name;
                                  // print_r($listNewN[$c->name.$league1->name]);
                                  ///this is to check if leauge exist or not
                                   if (!array_key_exists($league1->country_name . $league1->name, $listNewN)) {
                                          continue ;
                                        }
                                  //print_r($list1);
                                  // foreach ($listNewN as $cou => $list1) :
                                        $list1 = $listNewN[$league1->country_name . $league1->name];
                                        $listN1 = str_replace(" ", "", $league1->country_name . $league1->name) ;
                                        print_r($list1);
                                        $counters++;
