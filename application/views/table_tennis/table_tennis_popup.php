...
<html lang="en-US">
   ...
   <body class=" v3" >
      ...
      <div id="detail" class="sport-soccer" style="margin-top:0px;padding: 3px 3px;">
         <div id="detcon">
            <table class="detail">
               <thead>
                  <tr>
                     ...
                     <tr>
                        ...
                        <td id="flashscore_column">
                           <table>
                              <tbody>
                                 <tr>
                                    <td class="tname-home logo-enable"><span class="tname"><span style="display: none" class="dw-icon ico" title="">&nbsp;</span><a href="#"><?=$result[0]->home_team?></a></span></td>
                     ...
                     <table class="parts match-information">
                        <tbody>
                           <tr class="stage-header">
                              <td class="h-part" colspan="7">Maç Bilgileri</td>
                           </tr>
						   ...
						   <tr class="content odd <?php if ($result[0]->winner == 'a') {echo "bold";}?>">
                              <td>
                                 <?=$result[0]->home_team?><?=(!empty($result[0]->home_partner)?'/'.$result[0]->home_partner:'')?>
                              </td>
							  <td>
                                 <?=$result[0]->home_score?>
                              </td>
							  <td>
								 ...
								 <span class="rsut_img"><?=$result[0]->home_result[0]->tiebreak1?></span>
                              </td>
							  <td>
                                 <?=$result[0]->home_result[0]->set2?>
								 <span class="rsut_img"><?=$result[0]->home_result[0]->tiebreak2?></div>
                              </td>
							  <td>
                                 <?=$result[0]->home_result[0]->set3?>
								 <span class="rsut_img"><?=$result[0]->home_result[0]->tiebreak3?></span>
                              </td>
							  <td>
                                 <?=$result[0]->home_result[0]->set4?>
								 <span class="rsut_img"><?=$result[0]->home_result[0]->tiebreak4?></span>
                              </td>
							  <td>
                                 <?=$result[0]->home_result[0]->set5?>
								 <span class="rsut_img"><?=$result[0]->home_result[0]->tiebreak5?></span>
                              </td>
                           </tr>
						   <tr class="content even <?php if($result[0]->winner == 'b'){echo 'bold';}?>">
                              <td>
                                 <?=$result[0]->away_team?><?=(!empty($result[0]->away_partner)?'/'.$result[0]->away_partner:'')?>
                              </td>
							  <td>
                                 <?=$result[0]->away_score?>
                              </td>
							  <td>
								 ...
								 <span class="rsut_img"><?=$result[0]->away_result[0]->tiebreak1?></span>
                              </td>
							  <td>
                                 <?=$result[0]->away_result[0]->set2?>
								 <span class="rsut_img"><?=$result[0]->away_result[0]->tiebreak2?></span>
                              </td>
							  <td>
                                 <?=$result[0]->away_result[0]->set3?>
								 <span class="rsut_img"><?=$result[0]->away_result[0]->tiebreak3?></span>
                              </td>
							  <td>
                                 <?=$result[0]->away_result[0]->set4?>
								 <span class="rsut_img"><?=$result[0]->away_result[0]->tiebreak4?></span>
                              </td>
							  <td>
                                 <?=$result[0]->away_result[0]->set5?>
								 <span class="rsut_img"><?=$result[0]->away_result[0]->tiebreak5?></span>
                              </td>
                           </tr>
