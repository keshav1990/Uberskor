            ...
            <table class="detail">
               <thead>
                  <tr>
                     <th class="header">
                        <div class="fleft">
                           <span class="flag sml_flg_bk flag-<?=strtolower($result[0]->country)?>"></span><?=$result[0]->country?>: <a href="<?php echo base_url($game . '/') . url_title($result[0]->country, "dash", true) . '/' . str_replace('error','.',url_title(str_replace('.','error',$result[0]->stage_name), "dash", true))  ?>"><?=$result[0]->stage_name?>-<?=$result[0]->round?> </a>
                        </div>
                     </th>
                  </tr>
               </thead>
                     ...
                     <table class="parts match-information">
                        <tbody>
						   ...
						   <tr class="content odd <?php if ($result[0]->home_score > $result[0]->away_score ) {echo "bold";}?>">
							  ...
							  <td>
                                 <?=$result[0]->home_result[0]->halftime ?>
                              </td>
							  <td>
                                <?=$result[0]->home_result[0]->runningscore-$result[0]->home_result[0]->halftime ?>
                              </td>
							  <td>
                                <?php if($result[0]->home_score > $result[0]->home_result[0]->ordinarytime) { 
								echo $result->home_result[0]->ordinarytime;
							  }else{
								  echo "&nbsp;";
							  }
							  ?>
						   ...
						   <tr class="content even <?php if ($result[0]->home_score < $result[0]->away_score ) {echo "bold";}?> ">
							  ...
							  <td>
                                 <?=$result[0]->away_result[0]->halftime ?>
                              </td>
							  <td>
                                <?=$result[0]->away_result[0]->runningscore-$result[0]->away_result[0]->halftime ?>
                              </td>
							  <td>
                                <?php if($result[0]->away_score > $result[0]->away_result[0]->ordinarytime) { 
								echo $result->home_result[0]->ordinarytime;
							  }else{
								  echo "&nbsp;";
							  }
                           ...
                           <tr class="<?=$class?>">
                              <td class="summary-vertical fl">
                                 ...
                                 <div class="wrapper">
                                    ...
                                    <span class="participant-name"><a href="#"><?=$val->pname1?>.</a></span>
                              ...
                              <td class="summary-vertical fr">
								 ...
								 <div class="wrapper">
                                    ...
                                    <span class="participant-name">&nbsp;<a href="#"><?=$val->pname2?>.</a></span>
                                 </div>
								 <?php } ?>
                              </td>
                           </tr>
	           ...
	           <div id="tab-5" class="tab-content">
						  ...
						  <!----==Bottom Table html===------>
							...
							<table class="parts" style="width:50%; float:left;">
							   <tbody title="">
								<?php $i = 0; $class="odd"; foreach($home_lineup as $team1){ if ($team1->lineup_typeFK ==6 ){?>
								  <tr class="<?=$class?>">
									 <td class="summary-vertical fl">
							...
							<table class="parts" style="width:50%;">
							   <tbody title="">
								<?php $i = 0; $class="odd"; foreach($away_lineup as $team2){ if ($team2->lineup_typeFK ==6 ) { ?>
								<tr class="<?=$class?>">
									 <td class="summary-vertical fr">
