...
<!-- =============================================== -->
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <?=ucwords($this->uri->segment('3'))?> Game Banners
            ...
            <div class="col-md-12">
                  <!-- general form elements -->
                    <div class="box box-primary">
                      ...
                      <!-- /.box-header -->
                      <!-- form start -->
                     <?php echo form_open_multipart("admin-panel/banners/update_banners"); ?>
                        <div class="box-body">
                        ...
                        <input type="hidden" name="banner_type" value='<?php echo ($banners[4]->banner_type ? $banners[4]->banner_type : "logo");?>' >
                          <div class="form-group">
                            ...
                            <input type="file" name="banner" id="logo" onchange="fileUpload('logo')" required>
                          </div>
                    ...
                    <div class="box box-primary">
                     ...
                     <?php echo form_open_multipart("admin-panel/banners/update_banners"); ?>
                        ...
                        <input type="hidden" name="banner_type" value='<?php echo ($banners[0]->banner_type ? $banners[0]->banner_type : "top_banner");?>' >
                          <div class="form-group">
                            <label for="exampleInputFile">File input</label>
                            <input type="file" name="banner" id="top_banner" onchange="fileUpload('top_banner')" required>
                          </div>
                    ...
                    <div class="box box-primary">
                     ...
                     <?php echo form_open_multipart("admin-panel/banners/update_banners"); ?>
                        ...
                        <input type="hidden" name="banner_type" value='<?php echo ($banners[1]->banner_type ? $banners[1]->banner_type : "top_banner");?>' >
                          <div class="form-group">
                            <label for="exampleInputFile">File input</label>
                            <input type="file" name="banner" id="mid_banner" onchange="fileUpload('mid_banner')" required>
                          </div>
          ...
          <div class="row">
                    ...
                    <div class="box box-primary">
                     ...
                     <?php echo form_open_multipart("admin-panel/banners/update_banners"); ?>
                        ...
                        <input type="hidden" name="banner_type" value='<?php echo ($banners[3]->banner_type ? $banners[3]->banner_type : "top_banner");?>' >
                          <div class="form-group">
                            <label for="exampleInputFile">File input</label>
                            <input type="file" name="banner" id="left_banner" onchange="fileUpload('left_banner')" required>
                          </div>
            ...
            <div class="col-md-4">
                  <!-- general form elements -->
                    <div class="box box-primary">
                      <div class="box-header with-border">
                        <h3 class="box-title">Leftside Last Banner <small>140px x 93px</small></h3>
                      </div>
                      <!-- /.box-header -->
                      <!-- form start -->
                     <?php echo form_open_multipart("admin-panel/banners/update_banners"); ?>
                        <div class="box-body">
                          ...
                          <?php if (!empty($this->session->flashdata())) { ?>
                              ...
                              <?php  if ($this->session->flashdata('status')=='danger' && $this->session->flashdata('type')=='last_left_banner') { ?>
                              <div class="callout callout-danger">
                                <h4><i class="fa fa-warning"></i> Error!</h4>
                                <p><?php echo $this->session->flashdata('msg');?></p>
                              </div> 
                              ...
                              <?php  if ($this->session->flashdata('status')=='success' && $this->session->flashdata('type')=='last_left_banner') { ?>
                                <div class="alert_hide alert alert-success alert-dismissible">
                                <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
                                <h4><i class="icon fa fa-check"></i> Success</h4>
                                <?php echo $this->session->flashdata("msg"); ?>
                        ...
                        <img src="<?php echo $this->config->item('upload_url')."banners/".$banners[5]->image;?>" class="img-responsive" alt="Uberskor | Top-Banner" title="Uberskor | Top-Banner">
                        <input type="hidden" name="id" value="<?=$banners[5]->id?>">
                        <input type="hidden" name="banner_type" value='<?php echo ($banners[5]->banner_type ? $banners[5]->banner_type : "last_left_banner");?>' >
                          <div class="form-group">
                            <label for="exampleInputFile">File input</label>
                            <input type="file" name="banner" id="last_left_banner" onchange="fileUpload('last_left_banner')" required>
                          </div>
                        ...
                        <div class="box-footer">
                          <button type="submit"  id="btn_last_left_hbanner" class="btn btn-flat btn-primary btn-lg" >Update</button>
                        </div>
                      </form>
                    </div>
                    <!-- /.box -->
                    ...
                    <div class="box box-primary" >
                     ...
                     <?php echo form_open_multipart("admin-panel/banners/update_banners"); ?>
                        ...
                        <input type="hidden" name="banner_type" value='<?php echo ($banners[2]->banner_type ? $banners[2]->banner_type : "top_banner");?>' >
                          <div class="form-group">
                            <label for="exampleInputFile">File input</label>
                            <input type="file" name="banner" id="right_banner" onchange="fileUpload('right_banner')" required>
                          </div>
