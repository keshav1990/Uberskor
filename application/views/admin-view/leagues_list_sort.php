    ...
    <section class="content">
      <div class="row">
        <div class="col-md-12">
                      ...
                      <?php } ?>
        <!-- Profile Image -->
		<form method="post" action="<?php echo base_url();?>admin-panel/country/add_leagueslist" id="country_list">
          <div class="box box-primary">
            <div class="box-body box-profile">
			<input type="submit" name="submit" value="Save">
			
			<ul id="sortable_cntry">
			<?php if(!empty($leagues)){ foreach ($leagues as $lg): ?> 
			<li class="box-item" data-countryid="<?php echo $lg->id; ?>"><?php if($center==1){ echo $lg->name.' - '.$lg->country_name; } else {echo $lg->name;} ?></li>
			 <?php endforeach;}?>
			</ul>
			...
			<input type="hidden" value="<?php echo $countryid;?>" name="country_id" id="country_id">
              <input type="submit" name="submit" value="Save">
            </div>
          </div>
		  </form>
