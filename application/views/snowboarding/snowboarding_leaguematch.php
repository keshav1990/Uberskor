...
<style>    #def-form-table td input, textarea { padding: 4px 4px; margin-bottom: 8px;border-radius: 2px; }    #def-form-table td textarea {resize: none; }    #def-form-table td select  { width:159px;padding: 4px 4px;margin-bottom: 8px;border-radius: 2px;}
               ...
               <div id="tc-main">
				...
				<table class="soccer odds"  width="100%">
                        ...
                        <input type="checkbox" onchange='mygames("parent_<?=$parentID?>");' id="parent_<?=$parentID?>" >
                                       ...
                                       <td colspan="9" class="head_ab left project-bonus-border "><span class="country_name left"><span class="flag flag-<?=strtolower($row1->flag)?> left-odds" title=""></span><span class="name"><span class="tournament_part"> <?=$row1->league_name?> - <?=$row1->name?>  </span></span></span>
                                       </td>
                                    </tr>
									<tr class="league l_1_WbuOhZRa">
                                       <td colspan="1" class="head_aa ">
                                       ...
                                       <td colspan="9" class="head_ab left project-bonus-border "><span class="country_name left"><span class="left-odds" title=""></span><span class="name"><span class="country_part"><?=$row1->starttime?>,<?=$row1->startdate ?>, <?=$row1->discipline?>, <?=$row1->groupName?>-(<?=$row1->round?>) </span> </span></span>
                                       </td>
                                    </tr>
									<tr class="white"> 
                                      <td colspan="1"class="cell_ib icons ">&nbsp;</td>
									  <td colspan="1" class="cell_ad time">#</td>
									  <td colspan="4" class="cell_ib time">Sürücü</td>
									  <td colspan="1" class="cell_ad time">Duration</td>
									  <td colspan="3" class="cell_ad time">Startnumber</td>
                                    </tr>
                              </thead>
                              <tbody>
                              <?php  } foreach($row1->participants as $participant): if($participant->rank!=''){ ?>
                                    <tr onclick='detailPopup("<?=$row1->id?>");' class="tr-first even " style="cursor:pointer;">
                                       ...
                                       <td  colspan="4" class="cell_ad time "><?=$participant->racer_name?></td>
                                       <td  colspan="1" class="cell_ac team-away "><?=$participant->duration?></td>
									   <td  colspan="3" class="cell_ad time "><?=$participant->startnumber?></td>
                                    </tr>
                              <?php } endforeach; ?>
							  <tr class="blank-line">
							  <td colspan="10">
				...
				<table class="soccer odds"  width="100%">
                              <thead>
                                    <tr class="league l_1_WbuOhZRa" >
                                       ...
                                       <td colspan="9" class="head_ab left project-bonus-border "><span class="country_name left"><span class="flag  flag-<?=strtolower($row1->country_name)?> left-odds" title="<?=$row1->country_name?>"></span><span class="name"><span class="tournament_part"> <?=$row1->league_name?> - <?=$row1->name?>  </span></span></span>
                                       </td>
                                    </tr>
									<tr class="league l_1_WbuOhZRa">
                                       <td colspan="1" class="head_aa ">
  ...
  <div class="snw_lc_mainer" id="lc">
    ...
    <?php $this->load->view("snowboarding/sidebar"); ?>            
