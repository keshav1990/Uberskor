	 ...
	 $.getJSON(url , {date:date}, function( data ) {
		...
		$.each(data,function(e,v){
			...
			var pid = $(".<?=$game?>_event_"+v.id).attr("id");
				...
				trHtml1 += "<td onclick=\"detailPopup('"+v.id+"')\" rowspan=\"2\"   class=\"cell_ad time\">"+v.starttime+"<\/td>";
				trHtml1 += "<td onclick=\"detailPopup('"+v.id+"')\"  rowspan=\"2\"   class=\"cell_aa timer\"><span>"+v.status_text+"<\/span><\/td>";
				trHtml1 += "<td onclick=\"detailPopup('"+v.id+"')\" colspan=\"4\" class=\"cell_ab team-home ";
				...
				trHtml1 += "<\/td>";
				trHtml1 += "<td onclick=\"detailPopup('"+v.id+"')\"  colspan=\"1\" class=\"cell_se part-bottom\">"+isNull(v.home_result[0].set2)+"<\/td>";
				trHtml1 += "<td onclick=\"detailPopup('"+v.id+"')\"  colspan=\"1\" class=\"cell_sf part-bottom\">"+isNull(v.home_result[0].set3)+"<\/td>";
				trHtml1 += "<td onclick=\"detailPopup('"+v.id+"')\"  colspan=\"1\" class=\"cell_sf part-bottom\">"+isNull(v.home_result[0].set4)+"<\/td>";
				
				trHtml1 += "<td onclick=\"detailPopup('"+v.id+"')\" rowspan=\"2\" class=\"cell_oq comparison live_icon_data\">";
				...
				var trHtml2="";
				trHtml2 += " <td  colspan=\"4\" class=\"cell_ac team-away ";
				if(v.home_score < v.away_score){
					trHtml2 += "bold ";
				}
				trHtml2 +=  "\" >";
				...
				trHtml2 += "<td  colspan=\"1\" class=\"cell_sc score-home ";
				if(v.home_score < v.away_score){
					trHtml2 += "bold ";
				}
				trHtml2 +=  "\" >";
				...
				trHtml2 += " <td  colspan=\"1\" class=\"cell_sd part-bottom\">"+isNull(v.away_result[0].set1)+"";
				trHtml2 += "<\/td>";
				trHtml2 += "<td  colspan=\"1\" class=\"cell_se part-bottom\">"+isNull(v.away_result[0].set2)+"<\/td>";
				trHtml2 += "<td  colspan=\"1\" class=\"cell_sf part-bottom\">"+isNull(v.away_result[0].set3)+"<\/td>";
				trHtml2 += "<td  colspan=\"1\" class=\"cell_sf part-bottom\">"+isNull(v.away_result[0].set4)+"<\/td>";
