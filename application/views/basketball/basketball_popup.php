                     ...
                     <table class="parts match-information">
                        <tbody>
                           <tr class="stage-header">
                              <td class="h-part" colspan="5">Maç Bilgileri</td>
                           </tr>
						   ...
						   <tr class="content <?php if($result[0]->home_score > $result[0]->away_score){echo 'bold';}?>">
							  ...
							  <td>
                                 <?=$result[0]->home_result[0]->quarter1?>
                              </td>
							  <td>
                                 <?=$result[0]->home_result[0]->quarter2?>
                              </td>
							  <td>
                                 <?=$result[0]->home_result[0]->quarter3?>
                              </td>
							  <td>
                                 <?=$result[0]->home_result[0]->quarter4?>
                              </td>
                           </tr>
						   <tr class="even content <?php if($result[0]->away_score > $result[0]->home_score){echo 'bold';}?>">
							  ...
							  <td>
                                 <?=$result[0]->away_result[0]->quarter1?>
                              </td>
							  <td>
                                 <?=$result[0]->away_result[0]->quarter2?>
                              </td>
							  <td>
                                 <?=$result[0]->away_result[0]->quarter3?>
                              </td>
							  <td>
                                 <?=$result[0]->away_result[0]->quarter4?>
                              </td>
                           </tr>
