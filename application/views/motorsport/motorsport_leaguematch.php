				...
				<table class="soccer odds"  width="100%">
                              <thead>
                                    <tr class="league l_1_WbuOhZRa" >
                                       ...
                                       <td colspan="18" class="head_ab left project-bonus-border "><span class="country left"><span class="flag small small-<?=$row1->flag?> left-odds" title=""></span><span class="name"><span class="tournament_part"> <?=$row1->stage_name?> - <?=$row1->name?>  </span></span></span>
                                       </td>
                                    </tr>
									<tr class="league l_1_WbuOhZRa">
                                       <td colspan="1" class="head_aa ">
