<div id="fsbody" class="flashscore">
                ...
                <table class="soccer odds {str_class} pushLeague_in<?=$parentID?> LeaguePushID_in" colgroup="" id="{parent}_show<?=$parentID?>" width="100%">
                        ...
                        <input type="checkbox" onchange='mygames("parent_<?=$parentID?>")' id="parent_<?=$parentID?>" class="checkbox-custom" >
                                       ...
                                       <td colspan="12" class="head_ab left project-bonus-border "><span class="country left"><span class="left-odds flag flag-<?=strtolower($row1->flag)?>" title="<?=$row1->country ?>"></span><span class="name"><span class="tournament_part"> <?=$row1->name ?> </span></span></span>
							...
							<tr id="<?=$parentID?>" title="<?=$row1->eventname?>" class="<?=$game.'_event_'.$row1->id.'_1'?>  tr-first even stage-scheduled {str_child_class} {show_ck_tr} childRwckShow_<?=$row1->id?> parentRwckShow_<?=$parentID?> <?=$parentID?>" style="cursor:pointer;"  >
							  ...
							  <td onclick='detailPopup("<?=$row1->id?>");' rowspan="2" colspan="2" class="cell_ad time" title="Click on the details of the encounter!"><?php  if($row1->status_text != 'Bitti' && $row1->status_text !='Ertelendi' && $row1->gameStarted != '' && $row1->gameEnded==''){ ?>
										<span style="" class="Color_anited">
										 <b></b> 
										</span>
									   <?php } ?><?=$row1->starttime?></td>

							  <td onclick='detailPopup("<?=$row1->id?>");' rowspan="2" colspan="2" class="cell_aa timer" title=""><span><?=$row1->status_text?>-<?=$row1->stage_name?></span></td>

							  <td onclick='detailPopup("<?=$row1->id?>");' colspan="5" class="cell_ab team-home <?php if (strpos($row1->status_text, 'Bitti') !== false) { if($row1->winner == 'a') {echo "bold";} } ?>" title=""><span class="padl"><?=$row1->home_team?><span style="display:none;" class="mobile_only_score1"><?=$row1->home_score?></span></span></td>

							  <td onclick='detailPopup("<?=$row1->id?>");' colspan="1" class="cell_sc score-home <?php if (strpos($row1->status_text, 'Bitti') !== false) { if($row1->winner == 'a') {echo "bold";} } ?>" title=""><?=$row1->home_score?></td>
							...
							<tr id="<?=$parentID?>" title="<?=$row1->eventname?>" class="<?=$game.'_event_'.$row1->id.'_2'?>  tr-first even stage-scheduled {str_child_class} {show_ck_tr} childRwckShow_<?=$row1->id?> parentRwckShow_<?=$parentID?> <?=$parentID?>" style="cursor:pointer;"  >
							  <td onclick='detailPopup("<?=$row1->id?>");' colspan="5" class="cell_ac team-away <?php if (strpos($row1->status_text, 'Bitti') !== false) { if($row1->winner == 'b') {echo "bold";} } ?>" title=""><span class="padl"><?=$row1->away_team?><span style="display:none;" class="mobile_only_score2"><?=$row1->away_score?></span></span></td>

							  <td onclick='detailPopup("<?=$row1->id?>");' colspan="1" class="cell_ta score-away <?php if (strpos($row1->status_text, 'Bitti') !== false) { if($row1->winner == 'b') {echo "bold";} } ?>" title=""><?=$row1->away_score?></td>
							</tr>
							<tr class="blank-line">
							  <td colspan="13"></td>
							</tr>
                        ...
                        <input type="checkbox" onchange='mygames("parent_<?=$parentID?>")' id="parent_<?=$parentID?>" class="checkbox-custom" >
							...
							<tr id="<?=$parentID?>" title="<?=$row1->eventname?>" class="<?=$game.'_event_'.$row1->id.'_1'?>  tr-first even stage-scheduled {str_child_class} {show_ck_tr} childRwckShow_<?=$row1->id?> parentRwckShow_<?=$parentID?> <?=$parentID?>" style="cursor:pointer;"  >
							  ...
							  <td onclick='detailPopup("<?=$row1->id?>");' colspan="5" class="cell_ab team-home <?php if (strpos($row1->status_text, 'Bitti') !== false) { if($row1->home_score > $row1->away_score && $row1->home_score != $row1->away_score) {echo "bold";} } ?>" title=""><span class="padl"><?=$row1->home_team?><span style="display:none;" class="mobile_only_score1"><?=$row1->home_score?></span></span></td>
							...
							<tr id="<?=$parentID?>" title="<?=$row1->eventname?>" class="<?=$game.'_event_'.$row1->id.'_2'?>  tr-first even stage-scheduled {str_child_class} {show_ck_tr} childRwckShow_<?=$row1->id?> parentRwckShow_<?=$parentID?> <?=$parentID?>" style="cursor:pointer;"  >
							  <td onclick='detailPopup("<?=$row1->id?>");' colspan="5" class="cell_ac team-away <?php if (strpos($row1->status_text, 'Bitti') !== false) { if($row1->home_score < $row1->away_score && $row1->home_score != $row1->away_score) {echo "bold";} } ?>" title=""><span class="padl"><?=$row1->away_team?><span style="display:none;" class="mobile_only_score2"><?=$row1->away_score?></span></span></td>
