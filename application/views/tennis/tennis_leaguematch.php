...
#lc #my-leagues-list-1 li a {display: block !important;}
.a_sub_tg:after {    top: 9px;}
						...
						?>
                           ...
                           <div class="fs-table tab-content" style="<?php if($this->uri->segment('4') == '' ){ echo 'display:block;';}else{ echo 'display:none;';} ?>">
                              <div class="odds-content">
            							  ...
            							  <table class="soccer od_table_mx ft-ball_main">
                                          <thead class="no-border-bottom">
                                          	   <tr class="league l_1_ljIBgFCg primary-top">
                                          		  ...
                                          		  <span class="flag flag-<?=strtolower($list[0]->flag)?>" title="<?=$list[0]->country_name?>"></span>
                                    ...
                                    <tr class="event_round darkbg parent_match_day_<?=$j?>" style="display:none;"  >
                                       <td colspan="5"><span id="counter_<?=$i?>" class="counter"></span>. Maç Günü</td>
                                    </tr>
                                    <?php $j++; } ?>
                                    <tr title="<?=$val->eventname?>" onclick='detailPopup("<?=$val->id ?>");' class="<?=$class?> stage-finished cursor child_match_day_<?=($j-1)?>" style="display:none;" >
                                       <!--td colspan="1"class="cell_ib icons left" title=""></td-->
                                       <td colspan="1"class="cell_ad time"><?=$val->starttime?> <?=$val->startdate?></td>
                                       <td colspan="2"class="cell_ab team-home <?php if($val->home_score > $val->away_score){echo "bold";} ?>" ><span class="padr"><?=$val->home_team?> <?php if($val->teamType =='Team'){ echo '/'.$val->home_partner;}?> <span style="display:none;" class="mobile_only_score1"><?=$val->home_score?></span></span></td>
                                       <td colspan="1" class="cell_ac team-away <?php if($val->home_score < $val->away_score){echo "bold";} ?>"><span class="padl"><?=$val->away_team?><?php if($val->teamType =='Team'){ echo '/'.$val->away_partner;}?><span style="display:none;" class="mobile_only_score2"><?=$val->away_score?></span></span></td>
                                       <td colspan="1" class="cell_sa score  bold lst-clse"><?=$val->home_score?>&nbsp;:&nbsp;<?=$val->away_score?></td>
                                    </tr>
							 ...
							 <?php if(empty($list)){
								...
								<div class="table_takim">
                                    ...
                                    <tr title="<?=$val->eventname?>" onclick='detailPopup("<?=$val->id ?>");' class="<?=$class?> stage-finished cursor child_match_day_<?=($j-1)?>" style="display:none;" >
                                       ...
                                       <td colspan="2" class="cell_ab team-home <?php if($val->home_score > $val->away_score){echo "bold";} ?>" ><span class="padr"><?=$val->home_team?><?php if($val->teamType =='Team'){ echo '/'.$val->home_partner;}?> <span style="display:none;" class="mobile_only_score1"><?=$val->home_score?></span></span></td>
                                       <td class="cell_ac team-away <?php if($val->home_score < $val->away_score){echo "bold";} ?>" ><span class="padl"><?=$val->away_team?><?php if($val->teamType =='Team'){ echo '/'.$val->away_partner;}?> <span style="display:none;" class="mobile_only_score2"><?=$val->away_score?></span></span></td>
                       ...
                       <table class="soccer od_table_mx programlar_bg">
                        ...
                        <tbody>
                                    ...
                                    <tr id="g_1_ENxpnY1b" class="<?=$class?> stage-finished" style="cursor: pointer;">
                                       ...
                                       <td class="cell_ad time" ><?=$val2->startime?> <?=$val2->startdate?></td>
                     ...
                     <div class="mbox0px l-brd">
                        <ul class="menu country-list my-leagues">
                           ...
                           <ul id="my-leagues-list2" class="menu">
                              ...
                              <li><a href="<?php echo base_url($game).'/'.url_title($country_name,"dash",true)."/".url_title($row1->name,"dash",true)?>"><?=$row1->name?></a></li>
