...
?>
							 ...
							 <div id="tab-6" style="<?php if($this->uri->segment('4') == 'fikstur' ){ echo 'display:block;';}else{ echo 'display:none;';} ?>" class="fs-table tab-content">
							  ...
							  <table class="soccer od_table_mx programlar_bg">
								...
								<tbody>
                                    ...
                                    <tr title="<?=$val2->eventname?>"  onclick='detailPopup("<?=$val2->id?>");' id="g_1_ENxpnY1b" class="<?=$class?> stage-finished" style="cursor: pointer;">
                     ...
                     <div class="mbox0px l-brd">
                         <ul class="menu country-list my-leagues" title="">
                           ...
                           <ul id="my-leagues-list" class="menu" >
                              ...
                              <li><span class=" flag flag-<?=strtolower($row->flag)?>"></span> <span class="toggleMyLeague active "   ></span><a href="<?php echo base_url($game.'/').url_title($row->country_name,"dash",true).'/'.url_title($row->name,"dash",true)?>"><?=$row->name?></a></li>
                              <?php } ?>
                       <!-- - - -Irame BOx- - - - - -->
    ...
    <?php $this->load->view("cricket/sidebar"); ?>            
