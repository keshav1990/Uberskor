...
<div class="mbox0px l-brd flag_side">
   <ul class="menu country-list">
	   ...
	   <li><a title="<?php echo ucwords($c->name).': '.ucwords($league2->name) ?>" href="<?php echo base_url().$game.'/'.url_title($c->name,"dash",true).'/'.url_title($league2->name,"dash",true).'-'.$league2->id?>">
			<?=$league2->name?></a></li>
	   <?php endforeach; } ?>
	   </ul>
	   </li>
