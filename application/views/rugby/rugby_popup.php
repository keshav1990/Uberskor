                     ...
                     <table class="parts match-information">
                        <tbody>
                           <tr class="stage-header">
                              <td class="h-part" colspan="5">Maç Bilgileri</td>
                           </tr>
						   ...
						   <tr class="content odd <?php if($result[0]->away_score < $result[0]->home_score){echo 'bold';}?>">
                              <td>
                                 <?=$result[0]->home_team?>
                              </td>
							  <td>
							  ...
							  <td>
								<?php
								    if ($result[0]->home_score > $result[0]->home_result[0]->ordinarytime) {
						   ...
						   <tr class="content odd <?php if($result[0]->away_score > $result[0]->home_score){echo 'bold';}?>">
							  ...
							  <td>
								<?php
								    if ($result[0]->away_score > $result[0]->away_result[0]->ordinarytime) {
